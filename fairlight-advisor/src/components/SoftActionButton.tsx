...
export function SoftActionButton({
  ...
  return (
    <motion.button
      ...
      className={`group relative inline-flex items-center justify-center overflow-hidden rounded-full px-5 py-2.5 text-sm font-medium tracking-[-0.03em] whitespace-nowrap transition-[background-color,color,box-shadow,transform] duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.985] ${palette} ${className}`}
    >
